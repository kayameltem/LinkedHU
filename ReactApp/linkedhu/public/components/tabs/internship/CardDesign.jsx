...
const editAnnouncement = (e) => {
	...
	const announcementData = {'internship': {'announcementId': props?.data?.announcementId}, 'endDate': props?.data?.endDate};
	if(props.data.announcementId !== null || props.data.announcementId !== undefined)
	{
		const data = axios.post('http://localhost:8080/project/updateInternship', announcementData);
	}
}
...
const deleteAnnouncement = (e) => {
	...
	const announcementData = {'internship': {'announcementId': props?.data?.announcementId}};
	console.log(announcementData);
	if(props.data.announcementId !== null || props.data.announcementId !== undefined)
	{
		const data = axios.post('http://localhost:8080/internship/deleteInternship', announcementData);
	}
}
      ...
      <Modal show={show} fullscreen={true} onHide={handleClose}>
        ...
        <div className="row mt-5">
          <div className="col-lg-10 ms-5">
            ...
            <p><b>Internship Type:</b> {props.data.type}</p>
            <p><b>Salary:</b> {props.data.salary}</p>
